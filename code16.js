...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(16790236);
}
if (isConditionTrue_0) {
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(16798260);
}
if (isConditionTrue_0) {
/* Reuse gdjs.Lvl3_95IntroCode.GDSpeechBubble1Objects1 */
{for(var i = 0, len = gdjs.Lvl3_95IntroCode.GDSpeechBubble1Objects1.length ;i < len;++i) {
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(16798500);
}
if (isConditionTrue_0) {
/* Reuse gdjs.Lvl3_95IntroCode.GDSpeechBubble1Objects1 */
{for(var i = 0, len = gdjs.Lvl3_95IntroCode.GDSpeechBubble1Objects1.length ;i < len;++i) {
...
};gdjs.Lvl3_95IntroCode.eventsList4 = function(runtimeScene, asyncObjectsList) {
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(16771764);
}
if (isConditionTrue_0) {
/* Reuse gdjs.Lvl3_95IntroCode.GDDatesObjects2 */
/* Reuse gdjs.Lvl3_95IntroCode.GDMessageObjects2 */
{for(var i = 0, len = gdjs.Lvl3_95IntroCode.GDMessageObjects2.length ;i < len;++i) {
    gdjs.Lvl3_95IntroCode.GDMessageObjects2[i].getBehavior("Opacity").setOpacity(0);
}
}{for(var i = 0, len = gdjs.Lvl3_95IntroCode.GDDatesObjects2.length ;i < len;++i) {
    gdjs.Lvl3_95IntroCode.GDDatesObjects2[i].getBehavior("Opacity").setOpacity(0);
}
}}
...
};gdjs.Lvl3_95IntroCode.asyncCallback16770324 = function (runtimeScene, asyncObjectsList) {
...
{ //Subevents
gdjs.Lvl3_95IntroCode.eventsList4(runtimeScene, asyncObjectsList);} //End of subevents
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.Lvl3_95IntroCode.asyncCallback16770324(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.Lvl3_95IntroCode.asyncCallback16769524 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.Lvl3_95IntroCode.localVariables);
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(gdjs.Lvl3_95IntroCode.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.Lvl3_95IntroCode.asyncCallback16769524(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.Lvl3_95IntroCode.eventsList7 = function(runtimeScene) {
...
{for(var i = 0, len = gdjs.Lvl3_95IntroCode.GDFadeWObjects1.length ;i < len;++i) {
    ...
    gdjs.Lvl3_95IntroCode.GDMessageObjects1[i].getBehavior("Opacity").setOpacity(gdjs.Lvl3_95IntroCode.GDMessageObjects1[i].getBehavior("Opacity").getOpacity() + (5));
}
}{for(var i = 0, len = gdjs.Lvl3_95IntroCode.GDDatesObjects1.length ;i < len;++i) {
    gdjs.Lvl3_95IntroCode.GDDatesObjects1[i].getBehavior("Opacity").setOpacity(gdjs.Lvl3_95IntroCode.GDDatesObjects1[i].getBehavior("Opacity").getOpacity() + (5));
}
}{for(var i = 0, len = gdjs.Lvl3_95IntroCode.GDSpeechBubble1Objects1.length ;i < len;++i) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(16789644);
}
}
if (isConditionTrue_0) {
...
{ //Subevents
gdjs.Lvl3_95IntroCode.eventsList6(runtimeScene);} //End of subevents
}
...
gdjs.Lvl3_95IntroCode.eventsList7(runtimeScene);
gdjs.Lvl3_95IntroCode.GDLvl1_9595IntroBGObjects1.length = 0;
gdjs.Lvl3_95IntroCode.GDLvl1_9595IntroBGObjects2.length = 0;
gdjs.Lvl3_95IntroCode.GDLvl1_9595IntroBGObjects3.length = 0;
gdjs.Lvl3_95IntroCode.GDMainCharacterObjects1.length = 0;
